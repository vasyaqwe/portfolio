        ...
        <article
            ...
            className={`mb:pb-0 group relative mt-5 cursor-default overflow-hidden rounded-md border border-neutral-200 bg-neutral-100/50
             px-5 py-6 pb-0 shadow-md transition-colors hover:bg-neutral-200/75 sm:mt-8 sm:rounded-lg sm:px-7
              sm:py-8 md:grid md:min-h-[300px] md:grid-cols-2 md:gap-16 md:p-10 md:pb-0 lg:pb-0
             `}
        >
            <div className="flex flex-col gap-2 group-odd:col-start-2">
                ...
                <ul className="mb-4 mt-2 flex flex-wrap gap-2 sm:mt-6 md:my-4 lg:gap-3">
                ...
                <div className="mt-auto flex gap-3 pb-5 md:pb-10">
                    <Button
                        asChild
                        size={"sm"}
                        variant={"secondary"}
            ...
            <Image
                className={`${
                    ...
                    group-odd:col-start-1 group-odd:row-start-1 group-odd:justify-self-end md:col-start-2 md:min-w-[670px]
